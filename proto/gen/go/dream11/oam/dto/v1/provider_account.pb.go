...
var file_dream11_oam_dto_v1_provider_account_proto_goTypes = []interface{}{
...
func file_dream11_oam_dto_v1_provider_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dream11_oam_dto_v1_provider_account_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dream11_oam_dto_v1_provider_account_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProviderServiceAccountEnriched); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dream11_oam_dto_v1_provider_account_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProviderServiceAccount); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
