...
func (c *providerAccountServiceClient) GetProviderAccount(ctx context.Context, in *GetProviderAccountRequest, opts ...grpc.CallOption) (*GetProviderAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProviderAccountService_GetProviderAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerAccountServiceClient) GetProviderAccounts(ctx context.Context, in *GetProviderAccountsRequest, opts ...grpc.CallOption) (*GetProviderAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProviderAccountService_GetProviderAccounts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedProviderAccountServiceServer must be embedded to have forward compatible implementations.
