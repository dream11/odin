...
func file_dream11_od_component_v1_component_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dream11_od_component_v1_component_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_dream11_od_component_v1_component_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_dream11_od_component_v1_component_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_dream11_od_component_v1_component_proto_msgTypes[3].Exporter = func(v any, i int) any {
