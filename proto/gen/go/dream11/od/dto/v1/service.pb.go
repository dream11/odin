...
type Service struct {
	...
	Tags        string `protobuf:"bytes,10,opt,name=tags,proto3" json:"tags,omitempty"`     // JSON encoded string
	Labels      string `protobuf:"bytes,11,opt,name=labels,proto3" json:"labels,omitempty"` // JSON encoded string
}
...
var file_dream11_od_dto_v1_service_proto_rawDesc = []byte{
	...
	0xa9, 0x02, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76,
	...
	0x61, 0x67, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x0b, 0x20,
