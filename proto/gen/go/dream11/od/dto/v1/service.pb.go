...
type Service struct {
	...
	Labels      string `protobuf:"bytes,10,opt,name=labels,proto3" json:"labels,omitempty"` // JSON encoded string
}
...
var file_dream11_od_dto_v1_service_proto_rawDesc = []byte{
	...
	0x91, 0x02, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x65, 0x6c, 0x73, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_dream11_od_dto_v1_service_proto_goTypes = []interface{}{
	...
	(*Service)(nil),                     // 4: dream11.od.dto.v1.Service
