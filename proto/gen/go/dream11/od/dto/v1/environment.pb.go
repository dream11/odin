...
func file_dream11_od_dto_v1_environment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dream11_od_dto_v1_environment_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_dream11_od_dto_v1_environment_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_dream11_od_dto_v1_environment_proto_msgTypes[2].Exporter = func(v any, i int) any {
