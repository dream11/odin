...
func file_dream11_od_auth_v1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dream11_od_auth_v1_auth_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_dream11_od_auth_v1_auth_proto_msgTypes[1].Exporter = func(v any, i int) any {
