...
build:
	...
	mkdir -p bin/odin_linux_aarch64
	env GOOS=linux GOARCH=arm64 go build -o bin/odin_linux_aarch64/odin
compressed-builds: build
	...
	cd bin/odin_linux_aarch64 && tar -czvf ../odin_linux_aarch64.tar.gz odin